...
export class AdminSession {
  ...
  /**
   * Who this is. FROM THE SESSION, not from the profile.
   *
   * They are the same uuid, and the session is the one that is always there:
   * a profile is a separate query that can fail or lag behind the trigger
   * that creates it, and a signed-in person with no id yet is a page that
